...
if(isset($_POST['email']) && isset($_POST['password']) && isset($_POST['re_password'])){
    ...
    if($row > 0){
        ...
        if($matkhau != $re_matkhau){
            ...
            $sql = "INSERT INTO 
            `khachhang`(`MSKH`, `HoTenKH`, `DiaChi`, `SoDienThoai`, `Email`, `MatKhau`) 
            VALUES ('$mskh','$tenkh','$address','$sodienthoai','$email','$matkhauhoanchinh')";
            mysqli_query($conn,$sql);
            echo "<div class='alert alert-success' role='alert'>
                    Chúc mừng bạn đã đăng ký thành công ^.^ <a href='./login.php' class='lkdangnhap'>Vào đây</a> để đăng nhập.
                </div>";
        }
    }
...
<style>
    * {
    ...
    body {
        background-image: url("./assets/images/regis.jpg");
...
<body>
    <form action="#" method="POST" onsubmit="return validateForm()">
        ...
        <div class="form-group">
            ...
            <label for="name">Họ và tên của bạn(<span style='color:red'>*</span>)</label><input type="text" name="name" id="name" required>
        ...
        <div class="nut">
            ...
            <button onclick="window.location.href='./index.php'" id="submit" type="submit">Trở Lại</button>
        </div>
    </form>
